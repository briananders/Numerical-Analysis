...
def printAugMat(a,b):
    ...
    for i in range(len(a)): #builds every string to be printed and puts it in an array
        ...
        for j in range(len(a[0])):
            string += str(("%6.2f" % a[i][j])) + " " #%6.2f = float number with a total length of 6 (counting the decimal) with 2 decimal places.
        string += "| "
        string += str(("%6.2f" % b[i])) #%6.2f = float number with a total lenght of 6 (counting the decimal) with 2 decimal places.
        string += " ]"
...
def printMatA(a, pref):
    """
    prints two 2d array a as the matrix [a]
    """
    stringa = []
    prefs = ""
...
def printMatB(a, pref):
    """
    prints two 2d array a
    """
    stringa = []
    prefs = ""
    for i in range(len(pref)):
